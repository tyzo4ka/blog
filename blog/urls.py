...
from webapp.views import IndexView, ArticleView, ArticleCreateView, ArticleUpdateView, \
    ArticleDeleteView, CommentCreateView, CommentView, CommentUpdateView, CommentDeleteView
...
urlpatterns = [
    ...
    path("comment/all/", CommentView.as_view(), name="comments"),
    ...
    path('comment/<int:pl>/delete/', CommentDeleteView.as_view(), name="comment_delete")
]
